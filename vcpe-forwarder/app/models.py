...
class DesiredConfig(ForwarderModel):
    ...
    firewall_rules: dict[str, FirewallRule] = Field(default_factory=dict)
    steering_active_paths: dict[str, SteeringActivePathRequest] = Field(default_factory=dict)
    steering_load_balances: dict[str, SteeringLoadBalanceRequest] = Field(default_factory=dict)
